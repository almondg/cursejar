...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.person'
        db.alter_column('user_profile', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Person'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.person'
        db.alter_column('user_profile', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Person']))
