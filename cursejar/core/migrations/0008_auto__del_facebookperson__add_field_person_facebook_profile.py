...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_person', 'facebook_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.UserProfile']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Person.facebook_profile'
        db.delete_column(u'core_person', 'facebook_profile_id')
    ...
    models = {
        ...
        u'core.person': {
            ...
            'facebook_profile': ('django.db.models.fields.related.ForeignKey', [], {'default': "'NULL'", 'to': u"orm['core.UserProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        u'core.userprofile': {
