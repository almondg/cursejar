...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'UserProfile.id' to match new field type.
        db.rename_column('user_profile', u'id', 'ID')
        # Changing field 'UserProfile.id'
        db.alter_column('user_profile', 'ID', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column='ID'))

    def backwards(self, orm):
        # Adding field 'Person.facebook_profile'
        db.add_column(u'core_person', 'facebook_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserProfile'], null=True),
                      keep_default=False)

        # Deleting field 'UserProfile.person'
        db.delete_column('user_profile', 'person_id')


        # Renaming column for 'UserProfile.id' to match new field type.
        db.rename_column('user_profile', 'ID', u'id')
        # Changing field 'UserProfile.id'
        db.alter_column('user_profile', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'default': "'NULL'", 'to': u"orm['core.Person']"}),
