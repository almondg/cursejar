...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.facebook_profile'
        db.alter_column(u'core_person', 'facebook_profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserProfile'], null=True))

    def backwards(self, orm):

        # Changing field 'Person.facebook_profile'
        db.alter_column(u'core_person', 'facebook_profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserProfile']))
    ...
    models = {
        ...
        u'core.challenge': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.person': {
            ...
            'facebook_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.UserProfile']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        u'core.userprofile': {
