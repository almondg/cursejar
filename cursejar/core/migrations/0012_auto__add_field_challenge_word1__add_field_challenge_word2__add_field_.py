...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.word1'
        db.add_column(u'core_challenge', 'word1',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Challenge.word2'
        db.add_column(u'core_challenge', 'word2',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Challenge.word3'
        db.add_column(u'core_challenge', 'word3',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.word1'
        db.delete_column(u'core_challenge', 'word1')

        # Deleting field 'Challenge.word2'
        db.delete_column(u'core_challenge', 'word2')

        # Deleting field 'Challenge.word3'
        db.delete_column(u'core_challenge', 'word3')
    ...
    models = {
        ...
        u'core.challenge': {
            ...
            'word1': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'word2': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'word3': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'})
        },
        u'core.chargeevent': {
        ...
        u'core.userprofile': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Person']", 'null': 'True'}),
