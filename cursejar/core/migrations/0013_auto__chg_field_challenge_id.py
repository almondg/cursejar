...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Challenge.id' to match new field type.
        db.rename_column(u'core_challenge', u'id', 'ID')
        # Changing field 'Challenge.id'
        db.alter_column(u'core_challenge', 'ID', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column='ID'))

    def backwards(self, orm):

        # Renaming column for 'Challenge.id' to match new field type.
        db.rename_column(u'core_challenge', 'ID', u'id')
        # Changing field 'Challenge.id'
        db.alter_column(u'core_challenge', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
